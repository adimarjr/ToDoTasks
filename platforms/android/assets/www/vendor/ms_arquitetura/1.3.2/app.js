define([
        ...
        function() {
			...
			//var requireConfig = requirejs.s.contexts._.config;
                         ...
                         */
                        app.config(['$controllerProvider', '$provide', '$compileProvider', '$translateProvider',
			            function($controllerProvider, $provide, $compileProvider, $translateProvider){
				...
				app.controller = function( name, constructor ) {
                         ...
                         */
			app.config(['$httpProvider','$stateProvider', '$provide', 
