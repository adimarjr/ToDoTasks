 ...
 * @example
  <example animations="true">
      ...
      <div ng-controller="Ctrl">
        ...
        <div class="animate-switch-container"
          ng-switch on="selection">
            ...
            <div class="animate-switch" ng-switch-when="tasks">Home Span</div>
    ...
    <file name="script.js">
      function Ctrl($scope) {
        $scope.items = ['settings', 'tasks', 'other'];
    ...
    <file name="scenario.js">
      ...
      it('should change to tasks', function() {
        select('selection').option('tasks');
