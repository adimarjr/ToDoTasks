...
app.factory('ngTableParams', ['$q', '$log', function ($q, $log) {
    var isNumber = function (n) {
    	// se não for string iniciando com 0 (zero - '02') e for número
    	console.log((!(typeof n === 'string' && n.indexOf('0') === 0) && !isNaN(parseFloat(n)) && isFinite(n)));
        return (!(typeof n === 'string' && n.indexOf('0') === 0)
                ...
                if (params.hasOwnProperty(key)) {
                    ...
                    if (typeof item === "object") {
                        ...
                        if (asString) {
                            ...
                            pairs[name] = item;//encodeURIComponent(item);
                        }
                    }
                }
            }
